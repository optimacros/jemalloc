...
#define MALLOC_TSD_cleanup_yes(n, t) n##_cleanup(tsd);
#define MALLOC_TSD_cleanup_no(n, t)
#define O(n, t, c) MALLOC_TSD_cleanup_##c(n, t)
        MALLOC_TSD
...
JEMALLOC_ATTR(used)
    BOOL(WINAPI *const tls_callback)(HINSTANCE hinstDLL, DWORD fdwReason,
