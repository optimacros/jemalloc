...
malloc_tsd_externs(, tsd_t) malloc_tsd_funcs(JEMALLOC_ALWAYS_INLINE, , tsd_t,
                                             tsd_initializer, tsd_cleanup)

    JEMALLOC_ALWAYS_INLINE tsd_t *tsd_fetch_impl(bool init) {
...
#define O(n, t, c)                                                             \
    ...
    JEMALLOC_ALWAYS_INLINE t tsd_##n##_get(tsd_t *tsd) {                       \
        return (*tsd_##n##p_get(tsd));                                         \
                                                                               ...
                                                                               \
    JEMALLOC_ALWAYS_INLINE void tsd_##n##_set(tsd_t *tsd, t n) {               \
