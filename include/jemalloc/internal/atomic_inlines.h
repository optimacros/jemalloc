...
JEMALLOC_INLINE uint64_t atomic_add_u64(uint64_t *p, uint64_t x) {
    uint64_t t = x;
...
JEMALLOC_INLINE uint64_t atomic_sub_u64(uint64_t *p, uint64_t x) {
    uint64_t t;
...
JEMALLOC_INLINE bool atomic_cas_u64(uint64_t *p, uint64_t c, uint64_t s) {
    uint8_t success;

    asm volatile("lock; cmpxchgq %4, %0;"
                 "sete %1;"
...
JEMALLOC_INLINE void atomic_write_u64(uint64_t *p, uint64_t x) {
    asm volatile("xchgq %1, %0;"     /* Lock is implied by xchgq. */
                 : "=m"(*p), "+r"(x) /* Outputs. */
                 : "m"(*p)           /* Inputs. */
                 : "memory"          /* Clobbers. */
                 );
...
JEMALLOC_INLINE uint32_t atomic_add_u32(uint32_t *p, uint32_t x) {
    uint32_t t = x;
...
JEMALLOC_INLINE uint32_t atomic_sub_u32(uint32_t *p, uint32_t x) {
    uint32_t t;
...
JEMALLOC_INLINE bool atomic_cas_u32(uint32_t *p, uint32_t c, uint32_t s) {
    uint8_t success;

    asm volatile("lock; cmpxchgl %4, %0;"
                 "sete %1;"
                 : "=m"(*p), "=a"(success) /* Outputs. */
                 : "m"(*p), "a"(c), "r"(s) /* Inputs. */
                 : "memory");
...
JEMALLOC_INLINE void atomic_write_u32(uint32_t *p, uint32_t x) {
    asm volatile("xchgl %1, %0;"     /* Lock is implied by xchgl. */
                 : "=m"(*p), "+r"(x) /* Outputs. */
                 : "m"(*p)           /* Inputs. */
                 : "memory"          /* Clobbers. */
                 );
...
/******************************************************************************/
/* Pointer operations. */
JEMALLOC_INLINE void *atomic_add_p(void **p, void *x) {
#if (LG_SIZEOF_PTR == 3)
...
JEMALLOC_INLINE void *atomic_sub_p(void **p, void *x) {
#if (LG_SIZEOF_PTR == 3)
...
JEMALLOC_INLINE bool atomic_cas_p(void **p, void *c, void *s) {
#if (LG_SIZEOF_PTR == 3)
...
JEMALLOC_INLINE void atomic_write_p(void **p, const void *x) {
#if (LG_SIZEOF_PTR == 3)
...
/******************************************************************************/
/* size_t operations. */
JEMALLOC_INLINE size_t atomic_add_zu(size_t *p, size_t x) {
#if (LG_SIZEOF_PTR == 3)
...
JEMALLOC_INLINE size_t atomic_sub_zu(size_t *p, size_t x) {
#if (LG_SIZEOF_PTR == 3)
...
JEMALLOC_INLINE bool atomic_cas_zu(size_t *p, size_t c, size_t s) {
#if (LG_SIZEOF_PTR == 3)
    return (atomic_cas_u64((uint64_t *)p, (uint64_t)c, (uint64_t)s));
#elif (LG_SIZEOF_PTR == 2)
    return (atomic_cas_u32((uint32_t *)p, (uint32_t)c, (uint32_t)s));
...
JEMALLOC_INLINE void atomic_write_zu(size_t *p, size_t x) {
#if (LG_SIZEOF_PTR == 3)
    atomic_write_u64((uint64_t *)p, (uint64_t)x);
#elif (LG_SIZEOF_PTR == 2)
    atomic_write_u32((uint32_t *)p, (uint32_t)x);
...
/******************************************************************************/
/* unsigned operations. */
JEMALLOC_INLINE unsigned atomic_add_u(unsigned *p, unsigned x) {
#if (LG_SIZEOF_INT == 3)
...
JEMALLOC_INLINE unsigned atomic_sub_u(unsigned *p, unsigned x) {
#if (LG_SIZEOF_INT == 3)
...
JEMALLOC_INLINE bool atomic_cas_u(unsigned *p, unsigned c, unsigned s) {
#if (LG_SIZEOF_INT == 3)
    return (atomic_cas_u64((uint64_t *)p, (uint64_t)c, (uint64_t)s));
#elif (LG_SIZEOF_INT == 2)
    return (atomic_cas_u32((uint32_t *)p, (uint32_t)c, (uint32_t)s));
...
JEMALLOC_INLINE void atomic_write_u(unsigned *p, unsigned x) {
#if (LG_SIZEOF_INT == 3)
    atomic_write_u64((uint64_t *)p, (uint64_t)x);
#elif (LG_SIZEOF_INT == 2)
    atomic_write_u32((uint32_t *)p, (uint32_t)x);
