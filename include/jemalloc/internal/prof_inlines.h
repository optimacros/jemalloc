...
prof_tctx_t *prof_alloc_prep(tsd_t *tsd, size_t usize, bool prof_active,
                             bool update);
void prof_malloc(tsdn_t *tsdn, extent_t *extent, const void *ptr, size_t usize,
                 prof_tctx_t *tctx);
void prof_realloc(tsd_t *tsd, extent_t *extent, const void *ptr, size_t usize,
...
JEMALLOC_ALWAYS_INLINE void prof_tctx_set(tsdn_t *tsdn, extent_t *extent,
...
JEMALLOC_ALWAYS_INLINE void prof_tctx_reset(tsdn_t *tsdn, extent_t *extent,
                                            const void *ptr,
                                            prof_tctx_t *tctx) {
    cassert(config_prof);
    assert(ptr != NULL);
...
JEMALLOC_ALWAYS_INLINE void prof_malloc(tsdn_t *tsdn, extent_t *extent,
                                        const void *ptr, size_t usize,
                                        prof_tctx_t *tctx) {
    cassert(config_prof);
    assert(ptr != NULL);
    ...
    if (unlikely((uintptr_t)tctx > (uintptr_t)1U))
        ...
        prof_tctx_set(tsdn, extent, ptr, usize, (prof_tctx_t *)(uintptr_t)1U);
    }
}

JEMALLOC_ALWAYS_INLINE void prof_realloc(tsd_t *tsd, extent_t *extent,
                                         const void *ptr, size_t usize,
                                         prof_tctx_t *tctx, bool prof_active,
                                         bool updated, extent_t *old_extent,
    ...
    if (unlikely(sampled)) {
        prof_malloc_sample_object(tsd_tsdn(tsd), extent, ptr, usize, tctx);
    } else if (moved) {
...
JEMALLOC_ALWAYS_INLINE void prof_free(tsd_t *tsd, const extent_t *extent,
                                      const void *ptr, size_t usize) {
