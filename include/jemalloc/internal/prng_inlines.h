...
uint32_t prng_lg_range_u32(uint32_t *state, unsigned lg_range, bool atomic);
...
JEMALLOC_ALWAYS_INLINE uint32_t prng_lg_range_u32(uint32_t *state,
                                                  unsigned lg_range,
                                                  bool atomic) {
    uint32_t ret, state1;
...
JEMALLOC_ALWAYS_INLINE uint64_t prng_range_u64(uint64_t *state,
                                               uint64_t range) {
    uint64_t ret;
    unsigned lg_range;
