...
JEMALLOC_INLINE bool witness_owner(tsd_t *tsd, const witness_t *witness) {
...
JEMALLOC_INLINE void witness_assert_owner(tsdn_t *tsdn,
...
JEMALLOC_INLINE void witness_assert_not_owner(tsdn_t *tsdn,
                                              const witness_t *witness) {
    tsd_t *tsd;
    witness_list_t *witnesses;
    witness_t *w;
...
JEMALLOC_INLINE void witness_assert_lockless(tsdn_t *tsdn) {
    tsd_t *tsd;
    witness_list_t *witnesses;
    witness_t *w;
...
JEMALLOC_INLINE void witness_lock(tsdn_t *tsdn, witness_t *witness) {
    tsd_t *tsd;
    witness_list_t *witnesses;
    witness_t *w;
...
JEMALLOC_INLINE void witness_unlock(tsdn_t *tsdn, witness_t *witness) {
    tsd_t *tsd;
    witness_list_t *witnesses;
